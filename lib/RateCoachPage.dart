...
class _RateCoachPageState extends State<RateCoachPage> {
  ...
  try {
    final docRef = FirebaseFirestore.instance.collection('coach_ratings').doc(widget.name);
    ...
    Navigator.pop(context, average); // ✅ نرجّع المتوسط عشان يتم تحديثه في الواجهة
  } catch (e) {
